...
export default function CeremonyGuide({
  ...
  if (!activeRitual && rakhiState !== 'RAKHI_ATTACHED') {
    return <div className="ceremony-guide talk-guide"><div className="guide-kicker">YOUR NEXT STEP</div><strong>{nextStep}</strong><span>The next ceremony button unlocks after this step is complete.</span></div>;
  }
  return (
